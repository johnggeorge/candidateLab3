...
import { ShowtimeComponent } from 'app/entities/showtime/showtime.component';
...
describe('Component Tests', () => {
  describe('Showtime Management Component', () => {
    let comp: ShowtimeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShowtimeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.showtimes && comp.showtimes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
